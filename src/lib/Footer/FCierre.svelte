<script>
	import logo from './RS_horizontal_color.svg';
</script>

  
  <div class="text-white container flex flex-wrap mx-auto my-2 text-xs h-full w-full p-4 ">
    <div class="capa_copyright w-full sm:w-1/2 mb-4">
      <img src={logo} width="110" alt="Roi Scrol" />
      <p class="text-white mt-5">© Copyright 2022 Roi Digital Business, S.L. All rights reserved</p>
    </div> 
    <div class="capa_social w-full sm:w-1/2 ">
      
      <div class="lista_iconos_social flex flex-row gap-4 justify-item-end">
